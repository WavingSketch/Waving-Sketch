...
class Hash {
 public:
  static uint BOBHash32(const uchar* str, uint len, uint num) {
  ...
  static ulong BOBHash64(const uchar* str, uint len, uint num) {
    ulong a, b, c;
    ...
    while (len >= 24) {
      a += (str[0] + ((ulong)str[1] << 8) + ((ulong)str[2] << 16) +
            ((ulong)str[3] << 24) + ((ulong)str[4] << 32) +
            ((ulong)str[5] << 40) + ((ulong)str[6] << 48) +
            ((ulong)str[7] << 56));
      b += (str[8] + ((ulong)str[9] << 8) + ((ulong)str[10] << 16) +
            ((ulong)str[11] << 24) + ((ulong)str[12] << 32) +
            ((ulong)str[13] << 40) + ((ulong)str[14] << 48) +
            ((ulong)str[15] << 56));
      c += (str[16] + ((ulong)str[17] << 8) + ((ulong)str[18] << 16) +
            ((ulong)str[19] << 24) + ((ulong)str[20] << 32) +
            ((ulong)str[21] << 40) + ((ulong)str[22] << 48) +
            ((ulong)str[23] << 56));
      mix64(a, b, c);
      str += 24;
      len -= 24;
