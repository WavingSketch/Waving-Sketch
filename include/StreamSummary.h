...
public:
	class StreamBucket;
	class StreamCounter : public Node<Data<DATA_LEN>> {
	public:
		StreamBucket* parent;
		StreamCounter(Data<DATA_LEN> _ID) : Node<Data<DATA_LEN>>(_ID), parent(NULL) {}
	};
	...
	typedef std::unordered_map<Data<DATA_LEN>, StreamCounter*, My_Hash<DATA_LEN>> CounterMap;
	...
	inline count_type Query(const Data<DATA_LEN>& data) {
